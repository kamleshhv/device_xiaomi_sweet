# Common Device Tree
git clone -b blaze https://github.com/kamleshhv/device_xiaomi_sm6150-common.git device/xiaomi/sm6150-common
...
# Kernel Tree
git clone --depth=1 -b fourteen-old https://github.com/omnitrix21/kernel_xiaomi_sm6150.git kernel/xiaomi/sm6150
