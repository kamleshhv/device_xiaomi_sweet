git clone -b fourteen https://github.com/kamleshhv/device_xiaomi_sm6150-common.git device/xiaomi/sm6150-common

git clone -b thirteen https://github.com/kamleshhv/proprietary_vendor_xiaomi_sweet.git vendor/xiaomi/sweet
